...
public class SearchTest {
    public static void main(String[] args) {
        ...
        System.out.println(Search.otherLinearSearch(numArray, 38));
        System.out.println(Search.otherLinearSearch(numArray, 9));
        System.out.println(Search.otherLinearSearch(numArray, 5));
